---
title: "High resolution, landscape scale assessment of riparian impervious cover"
date: "`r Sys.Date()`"
format:
  docx: 
...
In the western United States, considerable uncertainty still surrounds basic measures of landscape-scale change and condition, despite the well-understood importance of riparian areas. Riparian ecosystems have experienced substantial ecological shifts following European colonization (Patten 1998, Poff et al. 2011), but a lack of quantitative estimates can hinder effective communication around policy objectives. The processes of defining regional restoration targets and negotiating the associated public expenditures clearly benefit from well-supported estimates of alteration. Here, we quantify riparian imperviousness at larger regional scales, using Washington State to examine outcomes and remaining challenges from approaches based on readily available public datasets.

Past research has indicated increasing impervious cover without clearly characterizing statewide riparian conditions in Washington. Jones et al. (2010) considered late 20th century land cover change (1973-2003) at a relatively coarse spatial resolution (60m) within a 180m buffer of National Hydrography Dataset (NHD) watercourses in several thousand sample blocks across the continental United States. They described a nationwide monotonic increase in the average riparian "urban %" over the assessed duration, and their results showed the Puget lowlands region of Washington had the nationally largest decrease in "natural land cover" during the "mid 80s - early 90s" period. A dramatic expansion of "urban" cover was also described by Powell et al. (2008) within Washington's Snohomish River watershed, draining to Puget Sound north of Seattle. Though not constrained to riparian areas, they estimated a 255% increase, from 3,285 ha in 1972 to 11,652 ha in 2006, based on an analysis combining manual orthophoto review with Landsat imagery. This study indicated that rapid impervious expansion during the 1980s slowed during the 1990s before returning to a faster rate after 2000. The authors recognized the potential for changing land use regulations to have contributed to this trajectory in conjunction with other social and economic factors. 
...
## CCAP 1m 2021 Impervious Surface
...
## StreamCat-processed National Land Cover Data
...
The 3.6m hectares included within the RDE spatial extent consisted primarily of SPTH~200yr~ RMZ polygons (approx. 3m ha, @tbl-overall) and encompassed a larger total area than that of the 2.6m ha of the StreamCat rp100. The medium-resolution NHDPlus underlying StreamCat captures larger streams and rivers but omits some small channels. Consequently, despite the wider 100m buffer in StreamCat, the RDE SPTH~200yr~ and default widths were imposed on the more extensive drainage network representation and longer stream length of the state standard NHD (@fig-overlay). However, spatial variation across the statewide domain was greater in the RDE assessed extent, as the fixed buffer dimension and coarser network of the StreamCat dataset produced per-county aggregate areas that primarily reflected overall county size (@fig-assessed a vs b and c vs d).  In contrast, the underlying intrinsic variation in watershed physiography was compounded by cartographic heterogeneity in NHD flowlines and ecoregional variation in SPTH~200yr~ values and missing site index data, leading to differences in RDE assessed extent among and within divisions by county boundaries. Notwithstanding these differences, the RDE proportions associated with both UGA boundaries and SWIFD-based salmon use followed expectations (@fig-assessed e and f), with higher concentrations of both in the western Puget Sound vicinity, as well as locations along the Columbia River with more urbanization (e.g., Clark County).
...
During the 2011-2017 period of the changes captured in the RDE-HRCD dataset, an estimated 947 ha of new impervious and 437 ha new semi-pervious cover were added to the assessed extent (2,341 and 1,080 acres respectively, @fig-impv_inc a). Differencing the 2011 and 2016 values in the Streamcat-NLCD dataset, high and medium intensity urban cover (>80% and 50-80% impervious respectively) increased by approximately 365 and 1152 hectares within the rp100 corridor (900 and 2,846 acres, @fig-impv_inc b). Combining these types per source, this corresponded to average annual increases of 231 ha/y for RDE-HRCD (158 + 73) and 303 ha/y for StreamCat-NLCD (73 + 230; @tbl-overall). The larger aggregate increase estimated from StreamCat-NLCD was more evenly distributed among county boundary divisions, including changes within lower population, more arid eastern areas where bare soil and rock surfaces may have contributed classification error. Absolute and proportional increases estimated from RDE-HRCD were more apparently clustered within the higher population areas of the state already subject to greater urbanization: in proximity to the large and rapidly growing metropolitan vicinities of Seattle, Tacoma, and Vancouver in western Washington (within King, Pierce, and Clark County bounds) and Spokane and the Tri-Cities in eastern Washington (within Spokane, Yakima, and Benton County bounds). The estimated area of additional riparian impervious cover made up a relatively small proportion of the total assessed area in both approaches, with no county exceeding 0.5% in either (@fig-impv_inc c and d). 

Riparian impervious cover increases in the RDE-HRCD were concentrated within reaches associated with UGAs statewide and with salmon use in western WA (compare @fig-impv_inc e and f to @fig-assessed e and f, @fig-swifd, a and b). For example, more than 90% of the estimated additional cover area was within UGA-associated reaches in King and Pierce counties in western WA, despite those reaches forming less than 25% of the total assessed extent. Although aggregate absolute increases were similar between non-salmon and salmon-associated reaches, the smaller overall extent of the latter meant that salmon-associated reaches had much greater relative density of impervious increases as recorded in the RDE-HRCD dataset (@fig-swifd, c).
...
Assessment of land cover change at the scale of whole watersheds is crucial to understanding the effects of land use policies. This statewide analysis showed continued increases of impervious cover within ecologically sensitive riparian areas. The results highlight the ongoing threats to aquatic systems from watershed alteration, and they underscore the need for continued attention to the definition and implementation of riparian regulations where "no net loss of ecological function and services" is a policy goal and statutory requirement (Riparian Taskforce 2024). Analogous to preventing the hardening of blood vessels that harms human health, halting the progression of "hydrosclerosis", whereby surface hardening hinders free flows of water, is critical to recovering river and watershed health.

The RDE-HRCD and Streamcat-NLCD approaches provided independent lines of evidence that statewide riparian impervious cover increased by hundreds of hectares annually during the 2010s. However, each is affected by distinct combinations of observation and processing error (@tbl-uncertainty), and the approximate convergence in aggregate total estimates may be coincidental. Nonetheless, the greatest differences in stream length and overall assessed extent were related to smaller, often headwater reaches. Many stream networks in Washington begin in steeper, forested areas that are less prone to urban land uses, while lower mainstem reaches tended to have more hydrographic agreement, reducing differences in assessed extents where human alteration of land cover tends to be more prevalent.
...
Future assessments are best addressed through the expanded use and further refinement of data at 1m or less resolution. The 30m land cover data was less suited to characterizing reach and site scale patterns, lacking the ability to capture the many areas of new impervious cover smaller than a single pixel. Application of the 2021 1m CCAP impervious cover layer provided a depiction of "status" well-suited to revealing patterns among different sub-areas experiencing varied land use pressures and regulatory regimes. However, a high resolution dataset of 2011 baseline land cover does not exist at the large extent and longer temporal duration of the coarser spatial data, hindering characterization of the observed changes according to the "before" condition or comparison against this later status. Future retrospective studies might explore the potential for data assimilation methods to downscale and re-classify older imagery from models trained on later high-resolution sources, while subsequent assessments may take advantage of newly available observations of post-2021 conditions. Such future extensions could also better disentangle impervious increases related to different activities (i.e., changes related to transportation or commercial versus residential construction), thereby clarifying how comparable amounts of population and housing growth may impose smaller or larger demands on riparian habitat conditions (Lambert et al. 2025). 

# Conclusion

Washington State laws seek to steward land and water, encouraging vibrant human communities without compromising the natural systems that sustain them. Yet, at a statewide scale, high resolution data indicate that hundreds of hectares of new impervious cover were added in areas near streams and rivers during the 2010s, and that such cover forms a substantial portion of many riparian zones within urban areas. Attention to this ongoing change will be critical to protecting and rehabilitating the ecological functions needed to recover healthy salmon populations and deliver other valued services.
