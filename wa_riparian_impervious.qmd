...
Cumulative assessments of land cover change are crucial to understanding the effects of land use regulations and policies, and this 
landscape-scale analysis of riparian corridors statewide showed ongoing increases in the extent of impervious cover within these previously altered and ecohydrologically sensitive portions of watersheds.
...
We analyzed high resolution land cover change data within an ecologically-grounded riparian corridor to quantify the magnitude of new impervious area in Washington state. A statewide estimate of `r round(rde_swifd_sum$impv_inc_ha[4])`ha (`r round(rde_swifd_sum$impv_inc_ac[4])` acres) during 2011 to 2017 represented `r round(100*rde_swifd_sum$impv_reach_pct[4], 3)`% of the total assessed extent. This estimate might be viewed as both a small portion of the entire riparian corridor and a large new addition to a sensitive portion of watersheds already subject to extensive alteration.
