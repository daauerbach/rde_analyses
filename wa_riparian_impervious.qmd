---
title: "Landscape assessment of high resolution change in riparian impervious cover"
date: "`r Sys.Date()`"
format:
  docx: 
...
Kenneth B Pierce, Ken Muir, Keith Folkerts, Robin Hale, Kara A Whittaker, Simone Des Roches 
...
The authors have no relevant financial or competing interests to disclose. **Funding for HRCD/RDE was provided by...**

# Abstract

Riparian ecosystems provide numerous services but face various threats to their integrity. Construction of impervious surfaces alters watershed hydrology and can degrade riparian ecological functions, necessitating environmental assessments of whole river networks to characterize these risks at landscape scales. To perform such an assessment we examined recent changes in impervious land cover within riparian areas in Washington State, USA. We generated statewide estimates based on a high-resolution change detection (HRCD) dataset, derived from aerial imagery and intersected with a variable width riparian buffer based on current management guidance, and we compared these against estimates based on moderate resolution, classified satellite imagery within a fixed buffer on a coarser, elevation-derived stream network. The high resolution dataset better captured the location and size distribution of individual changes, with a few large areas complemented by many that were smaller than a single 30x30m pixel. In aggregate, however, both approaches indicated statewide increases of impervious surfaces in riparian areas on the order of hundreds of hectares per year during the early and middle 2010s. Much of this change likely occurred outside of the jurisdictional extent of riparian land use regulation at the time, confirming that habitat impairment from new impervious surface remains a major threat and underscoring the importance of aligning regulated buffer widths with the dimensions needed to protect riparian ecosystem functions.
...
The construction of impervious surfaces is a major threat to riparian ecological integrity. In addition to the direct loss of terrestrial habitat, replacing native vegetation with concrete or other built elements prevents infiltration and alters watershed flow paths, impairing water quality and channel form (Schueler et al. 2009). Limiting this damage while accommodating multiple land uses is a core regulatory challenge, and status assessments are critical to determining how effectively decentralized permitting is achieving policy goals. In particular, evaluation at the landscape scale is needed to inform management, but such evaluation poses considerable technical challenges and may fall outside the direct responsibility of any single agency or authority.

Indeed, despite the well-understood importance of riparian areas and the attention devoted to their study, considerable uncertainty still surrounds basic measures of current conditions and changes at the landscape scale. Scientific consensus supports the qualitative claim that riparian ecosystems in the western United States have experienced "substantial" or "dramatic" ecological shifts following European colonization (Patten 1998, Poff et al. 2011), but broad quantitative estimates remain elusive, potentially hindering effective communication around policy objectives. For example, the absence of a clear, well-supported estimate can pose an obstacle to defining targets for regional restoration and negotiating associated public expenditures. This analysis addresses the need to quantify change in riparian imperviousness at larger regional scales, using Washington state as a focal example.
...
In Washington, an evaluation of impervious cover that addresses these challenges is possible because of high resolution change detection (HRCD) processing of aerial imagery at a 1m scale (Pierce 2015). The HRCD approach combines automated delineation of change polygons with extensive manual review and verification against before-after image pairs to generate a detailed characterization of land cover alteration. We used these data in conjunction with a statewide spatial dataset of riparian areas generated according to current management recommendations, and we compare the resulting estimates with those derived from an independent dataset of nationally available land cover within a fixed-width corridor on a different hydrography. Pacific salmon are central to regional culture and an important regulatory driver affected by the condition of riparian habitats. Accordingly, we also describe estimated increases in imperviousness relative to salmon distribution within river networks before discussing policy implications and opportunities for improving assessment.
...
```{r fig-swifd}
#| label: fig-swifd
#| fig-cap: "Concentration of impervious increases within salmon distribution; a) Change in human population during the time period of RDE-HRCD estimates; b) Magnitude of impervious cover increase within reaches associated with Chinook salmon distribution; c) Statewide impervious cover increase as proportion of total assessed area relative to salmon distribution"
...
#| fig-cap: "Characterization of per-reach impervious increase from high resolution change detection; a) Size distribution of individual per-reach increases in impervious cover (n = 7437, not showing 145 greater than 1 hectare); b) Cumulative increase by per-reach rank; c) Magnitude of impervious increase relative to the proportion of the floodplain type in the assessed reach area"
