...
KenP: "look at all the events over 5 acres. How many is that and what is the total increase for that bunch?"
...
statewide acres/year >300 including EOW
values are ~half of Lazarus
  - but those included 'low' and 'open', both of which are much more extensive
  - but these include 'floodplains' which are more extensive

```{r statewide_ac_year}
# #if Lazarus ~580-720ac/y for 2001:2019
# expand_grid(ac = c(11:13)*1000, y = 18:19) |> mutate(ac_y = ac/y)

#and HRCD is 2011:2017
rde_cnty |> 
  distinct(pid, .keep_all = T) |> 
  summarise(
    across(
  ...
  mutate(
    ac_y6 = nonfstry_impv_inc_ac / 6,
    ac_y7 = nonfstry_impv_inc_ac / 7
