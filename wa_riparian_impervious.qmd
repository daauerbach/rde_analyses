---
title: "Harder each year? Landscape scale assessment of riparian impervious cover change"
date: "`r Sys.Date()`"
format:
  docx: 
...
- accepted most phrasing changes and corrections, including revising to SPTH~200yr~ and adding several citations
...
Daniel A Auerbach (dan.auerbach@dfw.wa.gov), Kenneth B Pierce, Ken Muir, Keith Folkerts, Robin Hale, Kara A Whittaker, Simone Des Roches 
...
Landscape-scale environmental assessments are needed to characterize threats to the many ecosystem services provided in riparian areas. Such assessment is especially important for impervious surfaces, which alter watershed hydrology and degrade ecological functions. We examined recent trends in impervious land cover within riparian areas in Washington State, USA, by generating estimates from two existing, public datasets: high-resolution change detection (HRCD) locations based on aerial imagery from the National Agricultural Imagery Program and intersected with a variable width buffer based on current management guidance, and moderate resolution, classified satellite imagery from the National Land Cover Dataset calculated within a fixed buffer on a coarser, elevation-derived stream network. Aggregated statewide, both approaches indicated that impervious surface within riparian areas increased by hundreds of hectares per year during the early and middle 2010s. However, the HRCD dataset provided a more precise representation of the location and size distribution of new imperviousness. Although a substantial portion of the total statewide change was associated with a few large change areas, many detected changes were small, often less than the size of a single 30x30m pixel. In addition to clarifying key methodological considerations for future change evaluation, these results show that potential habitat degradation from new impervious surface remains a threat to riparian ecosystems, and that the width of regulated riparian buffers meant to limit new impervious surfaces warrants further deliberation by state and local policy makers.
...
Cumulative assessments of land cover change are crucial to understanding the effects of land use policies, and this statewide analysis showed increased impervious cover within ecologically sensitive riparian areas. The results highlight the ongoing threats to aquatic systems from watershed alteration and the need for continued attention to riparian regulations and their implementation where "no net loss of ecological function and services" is a policy goal and statutory requirement (Riparian Taskforce 2024). The hardening of blood vessels harms human health; recovering watershed health requires halting and reversing the analogous progression of "hydrosclerosis" whereby surface hardening hinders the free flux of matter and energy across land-water boundaries.

The RDE-HRCD and Streamcat-NLCD approaches provided different lines of evidence that statewide riparian impervious cover increased annually by hundreds of hectares during the first years of the 2010s. Each dataset has a distinct combination of observation and processing error, and the approximate convergence in the values of aggregate total estimates may be coincidental to some degree. However, the greatest dataset differences in stream length and assessed extent were related to smaller, often headwater reaches, and the upper portions of many stream networks in Washington are steeper, forested, and less prone to urban land uses. Larger, lower, mainstem reaches tended to have more hydrographic agreement, reducing differences in assessed extents where human alteration of land cover tends to be more prevalent.

In addition, an independent analysis by Lazarus (2023) also yielded estimates at a comparable order of magnitude
(@tab-overall). Lazarus (2023) extracted land cover from 2001-2019 NLCD within an alternative depiction of SPTH~200yr~ RMZs, based on similar methods to that developed for the RDE, while excluding sovereign tribal lands and using slightly different underlying hydrography. The spatial distribution of total increase was congruent with the findings here, and a total increase of approximately 4,768 ha of the high (947 ha) and medium (3,821 ha) intensity urban cover classes over this period gives an estimate of roughly 251ha/year on average.

With alternative approaches arriving at estimates of hundreds of hectares a year of new impervious cover within riparian and adjacent areas, a relevant question is whether a per-project "no net loss" standard can possibly have preserved ecological function at a cumulative scale. If hundreds of hectares of impervious cover are not being removed each year, are the mitigation actions that follow avoidance and minimization of impact adequate to offset the functional consequences of those that continue to be added?

This analysis illustrates key methodological choices that affect quantitative cumulative assessments: defining the spatial boundaries of evaluation and detecting differences within these bounds. The evaluation extent problem involves both the choice of a hydrographic representation and the width to extend laterally in the definition of riparian management zones, and the detection question in turn concerns the scale of change events. 
...
Washington State is a leader in land and water stewardship, striving to encourage vibrant human communities without compromising the natural systems that help make them vibrant. Yet, at a statewide scale during the 2010s, high resolution data indicate that hundreds of hectares of new impervious surface were added each year within sensitive riparian corridors. Attention to this ongoing change will be critical to continued progress towards salmon recovery and other valued aspects of ecological integrity within the framework of Washington's land use laws.

# Acknowledgements

Earlier versions of the manuscript were much improved thanks to comments by George Wilhere, Maddie Nolan, Reed Ojala-Barbour, and Braeden Van Deynze. We thank the team at ESA for their help preparing datasets and building the Riparian Data Engine web application, and we appreciate the ongoing development of the StreamCat data and associated tools.
