...
Daniel A Auerbach (dan.auerbach@dfw.wa.gov), Kenneth B Pierce, Ken Muir, Keith Folkerts, Robin Hale, Kara Whittaker 
...
## SPTH~200~ and floodplain corridor
...
tibble(
  Characteristic = c(
    ...
    "Total assessed riparian corridor area (ha)",
...
#| fig-cap: "Example location at junction of White and Puyallup Rivers in Sumner, WA (Pierce Co.) depicting alternative riparian corridors and high resolution change detection (HRCD) areas. SPTH~200~ RMZ (light green), EOW (blue), and floodplain (dark green) extents. StreamCatRp100 100m buffer on medium resolution NHDPlus (purple). HRCD impervious increases (grey)."
...
```{r fig-rde_cnty_zones_stacked_cols}
