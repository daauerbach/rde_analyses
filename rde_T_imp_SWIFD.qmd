...
needs development/polish, but illustrate multiwria progressive filter sequence?
describe as "necessary but insufficient" for standardized comparison between LEs/projects
```{r}
#begin with W WA
...
rde |>
  ...
  mutate(
    across(
      c(stream_miles, rmz_ac, tree_pct, average_solar),
      list(
