...
Increased "urban" or impervious cover within Puget Sound was also described by Bartz et al. (2015) on the basis of annual LandTrendr-derived changes in 30m imagery within 100m or 200m buffers of geographic features distinguished as important salmon habitat. Within the assessed areas, they estimated that, by 2008, mainstem zones gained roughly 172ha (~425ac, 3%) of impervious cover from ~5820ha in 1986 and that tributary zones increased roughly 119ha (294ha, 5.5%) from ~2,153ha. However, they also reported evidence of a "flatter" rate of increase in urban cover across these and the other nearshore, estuary, and floodplain habitat areas examined, with the timing of inflections varying considerably among habitat types and subbasins. These authors were unequivocal that a legacy of degradation continues to affect Puget Sound habitats, but they also concluded that more recent changes in land cover may indicate slower growth in additional impairment, perhaps attributable to a combination of cultural, economic and regulatory factors.


  - Folkerts et al 2020 mapping CAO project report?
...
- Add county level population change numbers? fit: urb_ac_rp100 ~ year + pop + housing
  - capture that per-person increases decreasing even as abs continues to increase? or just use bookend pop numbers
