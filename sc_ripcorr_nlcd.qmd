...
Examining estimated acres by urban cover class within the `rp100` for several example counties illustrates changes among NLCD-years (fig column-series)
...
saturating curves --> higher ratios at lower abs outside values 
notable scatter above linear inflections
